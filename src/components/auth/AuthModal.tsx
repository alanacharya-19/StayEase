    ...
    <div className="fixed inset-0 z-[100] grid place-items-center p-4">
      ...
      >
            ...
            <button
              ...
              className={`w-full flex items-center justify-center gap-3 px-4 py-2.5 rounded-lg text-sm font-medium transition-colors border ${
                isDark
            ...
            <div className="relative my-6">
              <div className={`absolute inset-0 flex items-center`}>
                <div className={`w-full border-t ${isDark ? 'border-dark-border' : 'border-gray-200'}`} />
              </div>
              <div className="relative flex justify-center text-xs uppercase">
                <span className={`px-2 ${isDark ? 'bg-dark-card text-gray-500' : 'bg-white text-gray-400'}`}>
